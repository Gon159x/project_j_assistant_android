...
import com.proyectoj.assistant.data.network.ApiClient
...
import com.proyectoj.assistant.features.logs.BuildLogsFormatter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun appendBuildLogs(newLogs: List<String>) {
        ...
        for (rawLine in newLogs) {
            val line = BuildLogsFormatter.format(rawLine) ?: continue
